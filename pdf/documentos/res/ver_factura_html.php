...
.border-top{
	border-top: solid 1px #7e04db;
	
}
.border-left{
	border-left: solid 1px #7e04db;
}
.border-right{
	border-right: solid 1px #7e04db;
}
.border-bottom{
	border-bottom: solid 1px #7e04db;
}
        ...
        <table class="page_footer">
            <tr>
                ...
                <td style="width: 50%; text-align: right">
                    &copy; <?php echo "EL MAURO"; echo  $anio=date('Y'); ?>
                </td>
            </tr>
        </table>
    </page_footer>
    <table cellspacing="0" style="width: 100%;">
        <tr>
			...
			<td style="width: 50%; color: #34495e;font-size:12px;text-align:center">
                <span style="color: #34495e;font-size:14px;font-weight:bold"><?php echo "El Mauro";?></span>
				<br><?php echo "VCB";?><br> 
				Teléfono: <?php echo "3122600";?><br>
				Email: <?php echo "maurocuran@vcb.com.co";?>
...
?>
        ...
        <tr>
            ...
            <td style="widtd: 15%; text-align: right;"> <?php echo ($subtotal);?></td>
        </tr>
		<tr>
            ...
            <td style="widtd: 15%; text-align: right;"> <?php echo ($total_factura);?></td>
        </tr>
    </table>
	...
	<br>
	<div style="font-size:11pt;text-align:center;font-weight:bold">Gracias por su compra en la siempre confiable Tienda El Mauro</div>
